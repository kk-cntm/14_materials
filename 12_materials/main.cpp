...
int main(int argc, const char * argv[]) {
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        cubeProgram.setValue("material.ambient", ambientColor);
        cubeProgram.setValue("material.diffuse", diffuseColor);
        cubeProgram.setValue("material.specular", glm::vec3(0.5f, 0.5f, 0.5f));
        ...
        lightProgram.setValue("lightColor", lightColor);
